...
class Test(unittest.TestCase):
    ...
    def test_1(self):
        ...
        test_cases = [[2,4,0.5], [2,2,1], [1,4, 0.25], [1,0,None]]
    ...
    def test_2(self):
        ...
        test_cases = [
            ...
            [ {'id': '0.5613286598732626', 'stock': 's3', 'timestamp': '2019-07-19 03:59:26.479899', 'top_bid': {'price': 13, 'size': 1}, 'top_ask': {'price': 0, 'size': 20}}, ("s3", 13, 0, 6.5)]
            ]
        for test_case in test_cases:
